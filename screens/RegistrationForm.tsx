            ...
            <>
              ...
              <View style={{ alignItems: "center", marginBottom: 16 }}>
                <PrimaryBtn
                  ...
                  type={termsAccepted ?"solid":"outline"}
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
             ...
             <PrimaryBtn title="Continue" type="solid" onPress={()=>{ navigation.navigate('user-categories'),setModalVisible(false)}}/>
             <PrimaryBtn title="Check Email" type="outline" onPress={() => {setModalVisible(false)}}/>
             </View>
            </View>
          </View>
        </Modal>
